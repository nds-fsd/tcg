    ...
    return (
        <div className={styles.homePagecontainer}>
            ...
            <p className={styles.homePageDescription}>
                Pixel-Quest-TCG es un emocionante juego de cartas de estilo medieval fantástico,
                donde podrás hacer amigos, enfrentarte en batallas épicas y coleccionar poderosas cartas.
            ...
            <div className={styles.homePageSections}>
                ...
                <div className={styles.homePageSection}>
                    ...
                    <p>
                        Ingresa a la arena y demuestra tu habilidad en batallas estratégicas contra otros jugadores.
                    </p>
