            ...
            <div className={styles.priceContainer}>
                {product.price.pixelcoins && (
                    <div className={styles.price}>
                        <img src="https://res.cloudinary.com/dsd7efrba/image/upload/v1739100321/moneda3tcg_hmxpum.png"
                            alt="Pixelcoins" className={styles.icon} />
                        <span>{product.price.pixelcoins} Pixelcoins</span>
                    </div>
                )}
                {product.price.pixelgems && (
                    <div className={styles.price}>
                        <img src="https://res.cloudinary.com/dsd7efrba/image/upload/v1739100320/gema4tcg_laiqk5.png"
                            alt="Pixelgems" className={styles.icon} />
