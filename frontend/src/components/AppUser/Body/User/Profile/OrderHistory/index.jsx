                    ...
                    <tbody>
                        {orders.map((order) => (
                            <tr key={order._id}>
                                ...
                                <td>
                                    {order.totalPrice.pixelcoins > 0 && (
                                        <span className={styles.priceItem}>
                                            <img src="https://res.cloudinary.com/dsd7efrba/image/upload/v1739100321/moneda3tcg_hmxpum.png" alt="Pixelcoins" className={styles.coinIcon} />
                                            {order.totalPrice.pixelcoins}
                                        </span>
                                    )}
                                    {order.totalPrice.pixelgems > 0 && (
                                        <span className={styles.priceItem}>
                                            <img src="https://res.cloudinary.com/dsd7efrba/image/upload/v1739100320/gema4tcg_laiqk5.png" alt="Pixelgems" className={styles.gemIcon} />
                                ...
                                <td className={order.status === "completada" ? styles.completed : styles.failed}>
                                    {order.status}
                                </td>
                            </tr>
                        ))}
