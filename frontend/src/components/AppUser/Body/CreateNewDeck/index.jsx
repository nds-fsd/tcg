  ...
  const [collectedCards, setCollectedCards] = useState([
    {
      ...
      type: 'Demon',
      rarity: 'Legendary',
      image: 'https://res.cloudinary.com/dsd7efrba/image/upload/v1735475902/lichetcg_ko6go8.png',
      description:
    ...
    },
    {
      ...
      description:
        'El roñoso esqueleto de un guerrero de antaño que abandona su tumba animado por la fuerza de la nigromancia, blandiendo las armas que usara en vida y vistiendo una degradada armadura. Ataca sin miedo, abriendo su boca para elevar un mudo grito de guerra.',
    },
    {
      id: 10,
      name: 'Goblin',
      ...
      description:
        'Este pequeño y detestable humanoide de piel verde suele acompañar a otros trasgoides en combate, aunque su moral es baja y suelen echarse a correr cuando la situación se complica. Aunque es un combatiente mediocre, su gran número compensa esa deficiencia.',
    },
    {
      id: 11,
      name: 'Orco',
      ...
      description:
        'Humanoide de piel verdosa y potente musculatura que saquea la civilización desde las tierras salvajes. Los orcos son saqueadores violentos con un desarrollado gusto por la sangre y el combate.',
    },
    {
      id: 12,
      name: 'Pegaso',
    ...
    },
    {
      ...
      description:
        'Rocosas aberraciones aladas, famosas tanto por su aspecto monstruoso como por su maldad. Es frecuente encontrarlas al servicio de las fuerzas del mal, pues gracias a su mimetismo natural y brutales garras son grandes guardianes.',
    },
    {
      id: 16,
      name: 'Doppelganger',
    ...
    },
    {
      ...
      description:
        'Criatura artefacto que puede volar. En su corazón descansa el secreto de la inmortalidad. Con él, no puedes perder el juego y tus oponentes no pueden ganarlo.',
    },
    {
      id: 19,
    ...
    },
    {
      ...
      description:
        'Tormenta de rayos fulminantes que causan un daño severo a aquellos a quien van dirigidos. Invocada desde la furia profunda de un poderoso hechicero.',
    },
    {
      id: 21,
      name: 'Relámpago',
