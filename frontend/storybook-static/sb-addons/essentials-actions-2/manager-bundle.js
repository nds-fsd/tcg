try {
  (() => {
    ...
    function L(e, t) {
      ...
      if (e && t && (r = e.constructor) === t.constructor) {
        ...
        if (r === Set) {
          ...
          for (n of e) if (((a = n), (a && typeof a == 'object' && ((a = je(t, a)), !a)) || !t.has(a))) return !1;
          return !0;
        }
        if (r === Map) {
          if (e.size !== t.size) return !1;
          for (n of e)
            if (((a = n[0]), (a && typeof a == 'object' && ((a = je(t, a)), !a)) || !L(n[1], t.get(a)))) return !1;
          return !0;
        }
        ...
        if (!r || typeof e == 'object') {
          n = 0;
          for (r in e) if ((Ue.call(e, r) && ++n && !Ue.call(t, r)) || !(r in t) || !L(e[r], t[r])) return !1;
    ...
    function ue(e, t, r) {
      if (typeof e == 'number' && typeof t == 'number' && typeof r == 'number') return le('#' + N(e) + N(t) + N(r));
      if (typeof e == 'object' && t === void 0 && r === void 0) return le('#' + N(e.red) + N(e.green) + N(e.blue));
      throw new _(6);
    }
    function Y(e, t, r, n) {
    ...
    var $t = 'actions',
      ...
      Qt = (e, t, r, n) => {
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let a of tt(t))
            !Zt.call(e, a) && a !== r && ge(e, a, { get: () => t[a], enumerable: !(n = qt(t, a)) || n.enumerable });
        return e;
      },
      er = (e, t, r) => (
        (r = e != null ? Jt(Xt(e)) : {}),
        Qt(t || !e || !e.__esModule ? ge(r, 'default', { value: e, enumerable: !0 }) : r, e)
      ),
      tr = be({
    ...
    var lr = (e) => Array.from({ length: e }, (t, r) => [Z].concat(Array.from({ length: r }, () => '*')).join('.')),
      ur = (e, t, r, n, a) => {
        let i = []
            .concat(lr(n))
            .concat(r)
      ...
      ot = k(({ name: e, data: t, dataIterator: r, nodeRenderer: n, expandPaths: a, expandLevel: i }) => {
        let s = S('TreeView'),
          l = G({}),
          [, u] = l;
        return (
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(at, { name: e, data: t, dataIterator: r, depth: 0, path: Z, nodeRenderer: n }),
            ),
          )
        );
      }),
    ...
    var me = ({ data: e }) => {
      ...
      fr = ({ name: e, data: t, isNonenumerable: r = !1 }) => {
        ...
        return o.createElement(
          'span',
          null,
          typeof e == 'string' ? o.createElement(Ee, { name: e, dimmed: r }) : o.createElement(me, { data: e }),
          o.createElement('span', null, ': '),
    ...
    var Er = ({ rows: e, columns: t, rowsData: r }) => {
      ...
      lt = Ne(({ children: e, className: t }, r) =>
        o.createElement(Pe, { ref: r, horizontal: !0, vertical: !0, className: t }, e),
      );
