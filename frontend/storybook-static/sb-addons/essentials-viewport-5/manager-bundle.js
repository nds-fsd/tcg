  ...
  (() => {
    ...
    var ye = (e, t, a, s) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let l of fe(t))
          !we.call(e, l) && l !== a && J(e, l, { get: () => t[l], enumerable: !(s = he(t, l)) || s.enumerable });
      return e;
    };
    var Se = (e, t, a) => (
      (a = e != null ? me(ge(e)) : {}),
    ...
    var $ = Se(ce()),
        ...
        return c.createElement(
          ...
          c.createElement(
            ...
            c.createElement(
              ...
              t !== P ? c.createElement(_e, null, t.name, ' ', l ? '(L)' : '(P)') : null,
            ),
          ),
      ...
      Ge = Q(function () {
        let [e, t] = G(),
          { viewports: a = Ie, defaultOrientation: s, defaultViewport: l, disable: b } = F(A, {}),
          p = Pe(a),
          o = oe(),
          [i, m] = z(!1);
        l &&
          ...
          O(() => {
            let u = s === 'landscape';
            ((l && e.viewport !== l) || (s && e.viewportRotated !== u)) && t({ viewport: l, viewportRotated: u });
          }, [s, l, t]);
        let n = p.find((u) => u.id === e.viewport) || p.find((u) => u.id === l) || p.find((u) => u.default) || D,
          d = ee(),
